                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-color"><strong> <?php echo $item_total; ?> CFA</strong></td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">mobile <img src="images/mtn&orange money.jpeg" alt="" width="90"></span> </label>
                                            </li>
                                        </ul>
