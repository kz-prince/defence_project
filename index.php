...
<body class="home">
    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="row">
                <?php
                $query_res = mysqli_query($db, "select * from products LIMIT 3"); // images displaying on the home page
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">' . $r['price'] . ' CFA</span> <a href="dishes.php?res_id=' . $r['rs_id'] . '" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
